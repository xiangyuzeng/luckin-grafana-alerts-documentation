...
|----------------|----------|
| **Alert ID** | ALR-033 |
| **告警名称 Alert Name** | 【DB告警】AWS-ES CPU 使用率大于90% |
| **优先级 Priority** | P1 |
...
### 中文说明
此告警在 **>90%** 条件满足时触发。该告警属于 **P1** 优先级，影响 **L1** 级别服务。
...
### English Description
This alert triggers when the condition **>90%** is met. This is a **P1** priority alert affecting **L1** level services.
...
```
1. 告警名称和ID / Alert name and ID: 【DB告警】AWS-ES CPU 使用率大于90% (ALR-033)
